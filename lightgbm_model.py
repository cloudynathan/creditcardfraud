...
params = {'max_depth': [4, 6, 8], 'learning_rate': [0.1, 0.01], 'colsample_bytree': [0.6, 0.8], 'n_estimators': [20, 50]}
kf = StratifiedKFold(n_splits=5, shuffle=True, random_state=123)

grid = GridSearchCV(clf, params, scoring='roc_auc', cv=kf, verbose=2, n_jobs=6)
